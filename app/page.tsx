    ...
    <div className="flex flex-col space-y-5 items-center justify-center h-full p-5 text-neutral-20">
      ...
      <Link href={"/dashboard"}>
        <Button
          variant="default"
          type="submit"
          className="w-fit font-inter font-bold text-[16px] md:text-[18px] lg:text-[20px] leading-[1.5] tracking-[0%] rounded-full p-7 cursor-pointer bg-violet-500 text-neutral-800 hover:bg-violet-600 focus:ring-2 focus:ring-violet-500 focus:ring-offset-0"
        >
